...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 10;
...
const char     CRYPTONOTE_NAME[]                             = "Brogniart Coin";
...
const int      P2P_DEFAULT_PORT                              = 22775;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 22770;
